...
public class Ex03_Binary {
	...
	public static void main(String[] args) {
		...
		double res3 = c / (double)d;	//	연산할 때 실수 변환, 올바른 결과 도출
		...
		//	실수 비교
		System.out.println(3.0 == 3.0);								//	실수연산에서 같으나를 비교하는 것은 위험
		System.out.println(Math.abs(3.0 - (1.2+3.3-1.5)) < 1e-15);	//	차이의 철대값이 1E-15보다 작냐로 비교
